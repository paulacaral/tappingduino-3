# -*- coding: utf-8 -*-
"""
Created on Wed Mar 11 14:16:38 2020
...
while (block_counter < N_blocks):
    ...
    filename_block = '/home/paula/Tappingduino3/tappingduino-3-master/Datos/BUGRTACK_S'+next_subject_number+"-"+timestr+"-"+"block"+str(block_counter)+"-trials" 
    ...
    while (trial < N_trials_per_block):
        ...
        filename_raw = '/home/paula/Tappingduino3/tappingduino-3-master/Datos/BUGRTACK_S'+next_subject_number+"-"+timestr+"-"+"block"+str(block_counter)+"-"+"trial"+str(trial)+"-raw.dat"
        f_raw = open(filename_raw,"w+")
     
        # generate extracted data file name (will save raw data, stimulus time, feedback time and asynchrony)
        filename_data = '/home/paula/Tappingduino3/tappingduino-3-master/Datos/BUGRTACK_S'+next_subject_number+"-"+timestr+"-"+"block"+str(block_counter)+"-"+"trial"+str(trial)

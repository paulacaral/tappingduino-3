# -*- coding: utf-8 -*-
"""
Created on Wed Mar 11 13:37:45 2020
...
filename_orders = '/home/paula/Tappingduino3/tappingduino-3-master/Datos/Posibles_permutaciones_condiciones_bugtrack.dat'
...
filename_names = "/home/paula/Tappingduino3/tappingduino-3-master/Datos/Dic_names_pseud_bugtrack.dat"
...
while (block_counter < N_blocks):
    ...
    filename_block = '/home/paula/Tappingduino3/tappingduino-3-master/Datos/BUGTRACK_S'+next_subject_number+"-"+timestr+"-"+"block"+str(block_counter)+"-trials" 
    ...
    while (trial < N_trials_per_block):
        ...
        filename_raw = '/home/paula/Tappingduino3/tappingduino-3-master/Datos/BUGTRACK_S'+next_subject_number+"-"+timestr+"-"+"block"+str(block_counter)+"-"+"trial"+str(trial)+"-raw.dat"
        f_raw = open(filename_raw,"w+")
     
        # generate extracted data file name (will save raw data, stimulus time, feedback time and asynchrony)
        filename_data = '/home/paula/Tappingduino3/tappingduino-3-master/Datos/BUGTRACK_S'+next_subject_number+"-"+timestr+"-"+"block"+str(block_counter)+"-"+"trial"+str(trial)
        ...
        subject_number_load = '003'
        block_load = 3
        trial_load = 3
        filename_raw_load = glob.glob('/home/paula/Tappingduino3/tappingduino-3-master/Datos/S'+subject_number_load+"-*-block"+str(block_load)+"-trial"+str(trial_load)+"-raw.dat")
